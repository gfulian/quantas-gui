...
def layout() -> html.Div:
    ...
    return development_page(
        ...
        summary='Equilibrium volume, thermal expansion, heat capacities and free-energy minimization over pressure and temperature.',
        next_step='The GUI will preserve inspection and diagnostic stages instead of hiding fitting and minimization choices.',
    )
