...
def layout() -> html.Div:
    ...
    return development_page(
        ...
        summary=(
            "Calibrate elastic tensors against volume, evaluate P–T grids, "
            "and follow geothermobarometric profiles."
        ),
        next_step=(
            "The page will explicitly separate calibration, analysis, "
            "profiles, and transfer to SEISMIC."
        ),
    )
